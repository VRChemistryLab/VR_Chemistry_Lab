...
class NaBr2Simulation:
    def __init__(self, maxTimestepInSimulation):
        ...
        self.STARTIN_MOL_OF_BR2 = 0.04 #about the amout of a 2ml of br2, (should be some drops)
        self.YAML_PATH = "reaction_definitions/NaBr2.yaml"
    ...
    def init(self, T0, f_amountInMol=None, p0=ct.one_atm):
        ...
        self.gas.TPX = T0, p0, {"Br2": self.STARTIN_MOL_OF_BR2}
        self.br2_initial = self.STARTIN_MOL_OF_BR2
        ...
        self.i_NaBr = self.surface.species_index("NaBr")
        ...
        try:
            while self.time < t_end:
                ...
                results.append( {
                    ...
                    "amount_of_NaBr": self.surface.coverages[self.i_NaBr],

                    # gas
                    "amount_of_Br2": float(gas.X[self.i_Br2] * n_total / self.br2_initial),
                } )
